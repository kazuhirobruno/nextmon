  ...
  return (
    <div className="flex flex-col md:flex-row h-screen w-full">
      ...
      <div className="flex flex-col md:hidden">
        <div className="bg-[#0a0a0a] text-white p-2">
          <CustomDropdown pokemons={pokemons} />
        </div>
        <main className="overflow-auto p-4 bg-[#0a0a0a] text-white">
        {children}
      </main>
      </div>
      ...
      <div className="hidden md:flex flex-row w-full h-screen">
        <aside className=" w-72 border-r border-gray-700 bg-[#0a0a0a] text-white overflow-y-auto">
